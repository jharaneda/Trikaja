					...
					<div class="col">
						<table class="table table-striped table-hover" id="ticketList" data-striped="true" data-sort-name="name" data-search="true">
							<tbody>
								...
								<tr>
									<td class="input-group mb-3 form-floating"><form:textarea path="comment" class="form-control" id="floatingTextarea" style="min-width:100px; max-width:100%;min-height:50px;height:100%;width:100%;" required="required" /> <label for="floatingTextarea">Write your predefined answer</label></td>
								</tr>
								<tr>
