...
<body>
	...
	<section class="home-section">
		<div class='container'>
			<h1>Update Ticket</h1>
			<form:form
				action="${pageContext.request.contextPath}/manager/tickets/update"
							...
							<tbody>
								<tr style="display: none">
									<td><span class="input-group-text" id="basic-addon1">ID</span>
										<form:input path="id" class="form-select" readonly="true" /></td>
								</tr>
								<tr>
									<td><span class="input-group-text" id="basic-addon1">Creation
											Date</span> <form:input path="creationDate" class="form-select"
											readonly="true" /></td>
								</tr>
								<tr>
