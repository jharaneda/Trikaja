...
public class TicketDAOImpl {
	...
	public boolean createTicket(TicketModel_jar_86 createTicket) {
		return jdbcTemplate.update(SQL_CREATE_TICKET, createTicket.getCreationDate(), createTicket.getStatus(), createTicket.getUserCreator(), createTicket.getAssigneeUser(), createTicket.getTypeOfTicket(), createTicket.getPriority(), createTicket.getPosition(), createTicket.getHardwareToBeChanged(), createTicket.getCommentsID()) > 0;
	}
